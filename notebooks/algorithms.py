...
def get_best_locations(algorithm_func, realty_gdf, pvz_gdf, top_n=5, **kwargs):
    ...
    return result_gdf[REQUIRED_COLUMNS].copy()


def naive_strategy(realty_gdf, pvz_gdf, top_n=5):
    """
    АЛГОРИТМ 1: Наивный
    Просто берет Топ-5 помещений в самых густонаселенных гексагонах без ПВЗ
    Игнорирует каннибализацию (точки могут встать в соседних домах)
    """
